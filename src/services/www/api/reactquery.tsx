...
export function PersistQueryClientProvider({ children }: PersistQueryClientProviderProps): JSX.Element {
  ...
  if (isClient) {
    ...
    return (
      <RQPersistQueryClientProvider client={queryClient} persistOptions={persistOptions}>
        {children}
...
export type UseQueryOptions<TResponse, TQueryKey extends QueryKey = QueryKey> = Omit<
...
export function useQuery<TResponse, TQueryKey extends QueryKey = QueryKey>(
  ...
  return rqUseQuery<AxiosResponse<TResponse>, unknown, AxiosResponse<TResponse>, TQueryKey>({
    queryFn: async (ctx) => {
...
export function useMutation<TVariables, TData>(
  ...
  return rqUseMutation({
    ...
    onSettled: async (data, error, variables, context) => {
      ...
      options?.onSettled && (await options?.onSettled(data, error, variables, context))
    },
  })
}
